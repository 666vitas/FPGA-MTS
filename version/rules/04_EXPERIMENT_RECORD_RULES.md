# 04_EXPERIMENT_RECORD_RULES — HISTORICAL / NOT ACTIVE

> **HISTORICAL / NOT ACTIVE**：旧阶段实验模板仅作历史参考。当前证据等级、唯一实验格式和记录边界见 `20_FPGA_MTS_ENGINEERING_WORKFLOW.md` 与当前 Gate SOP。
